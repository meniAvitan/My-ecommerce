export const ORDER_CRAETE_REQUEST = 'ORDER_CRAETE_REQUEST';
export const ORDER_CRAETE_SUCCESS = 'ORDER_CRAETE_SUCCESS';
export const ORDER_CRAETE_FAIL = 'ORDER_CRAETE_FAIL';
export const ORDER_CRAETE_RESET = 'ORDER_CRAETE_RESET';
